...
@click.option(
    "--dataset_path",
    "-d",
    default="/home/gx4070/Desktop/arm-datasets-collect/data/piper_xy",
    help="Directory containing Piper .hdf5 episodes.",
)
@click.option("--config-name", default="train_diffusion_unet_piper_real_image_workspace")
